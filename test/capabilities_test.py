...
def test_minimal_app_collects_clean_payload(no_host_binaries):
...
def test_stateful_manager_proxy_unwrap_for_manager_type(no_host_binaries):
...
def test_collect_all_capabilities_returns_per_manager_dict(no_host_binaries):
...
def test_collect_all_capabilities_skips_failing_manager(caplog, no_host_binaries):
